<?php
    if(isset($_POST['submit'])){
        ...
        $result = mysqli_query($conexao, "INSERT INTO usuarios(nome, email, usuario, senha, sexo, data_nasc, cidade, estado, endereco) VALUES ('$nome', '$email', '$usuario' ,'$senha', '$sexo', '$data_nasc', '$cidade', '$estado', '$endereco');");
...
<head>
    ...
    <title>Cadastro BeatBridge</title>
